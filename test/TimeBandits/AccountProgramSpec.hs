...
module TimeBandits.AccountProgramSpec (spec) where

import Test.Hspec
import Data.Map.Strict qualified as Map
import Data.ByteString.Char8 qualified as BS

import TimeBandits.Core.Common.Types (ActorId)
...
import TimeBandits.Core.Types (LamportTime)
...
mockActorId :: CoreActorId.ActorId
mockActorId = CoreActorId.ActorId "actor-123"
